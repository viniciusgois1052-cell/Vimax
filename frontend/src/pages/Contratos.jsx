                            ...
                            <form onSubmit={handleLembreteSubmit} className="bg-amber-50 border border-amber-100 rounded-xl p-4 space-y-3">
                                ...
                                <div>
                                    ...
                                    <input
                                        required
                                        type="text"
                                        placeholder="Ex: Renovar contrato, Enviar documentação..."
                                        className="w-full p-2 border border-amber-200 rounded-lg outline-none focus:ring-2 focus:ring-amber-400 bg-white text-sm"
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e => setLembreteForm({ ...lembreteForm, data_lembrete: e.target.value })}
                                        />
                                    </div>
                                    <div>
                                ...
                                <div className="flex gap-2 justify-end">
                                    {lembreteEditingId && (
                                        <button
                                            type="button"
                                            onClick={() => { setLembreteEditingId(null); setLembreteForm({ titulo: '', descricao: '', data_lembrete: '' }); }}
                                            className="px-4 py-2 text-sm rounded-lg bg-gray-100 text-gray-600 font-bold hover:bg-gray-200"
                                        >
                                            Cancelar
                                        </button>
                                    )}
                                    <button
                                        ...
                                        className="px-5 py-2 text-sm rounded-lg bg-amber-500 hover:bg-amber-600 text-white font-bold shadow transition-all disabled:opacity-50"
                                    >
                                ...
                                {lembretes.map(l => {
                                    ...
                                    return (
                                        ...
                                        >
                                            {/* Checkbox concluído */}
                                            <button
                                                onClick={() => handleLembreteConcluir(l)}
                                                className={`mt-0.5 w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 transition-all ${
                                                    l.concluido ? 'bg-green-500 border-green-500 text-white' : 'border-gray-300 hover:border-green-400'
                                                }`}
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className={`font-bold text-sm ${l.concluido ? 'line-through text-gray-400' : vencido ? 'text-red-700' : 'text-gray-800'}`}>
                                                    {l.titulo}
                                                </p>
                                            ...
                                            <div className="flex gap-1 shrink-0">
                                                {!l.concluido && (
                                                    <button onClick={() => handleLembreteEdit(l)} className="p-1.5 text-blue-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg" title="Editar">
                                                        <FaEdit size={12} />
                                                    </button>
                                                )}
                                                <button onClick={() => handleLembreteDelete(l.id)} className="p-1.5 text-red-400 hover:text-red-600 hover:bg-red-50 rounded-lg" title="Excluir">
                                                    <FaTrashAlt size={12} />
                                                </button>
                                            </div>
                                        </div>
