        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                    <FaTag className="text-indigo-600" /> Grupos — Email Marketing
                </h1>
                <button
                        ...
                        {filteredGrupos.length === 0 ? (
                            ...
                            <tr key={g.id} className="hover:bg-indigo-50/30 transition-colors">
                                <td className="px-6 py-4 font-semibold text-gray-800 flex items-center gap-2">
                                    <FaTag className="text-indigo-400" /> {g.nome}
                                </td>
                                ...
                                <td className="px-6 py-4">
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full text-sm font-bold hover:bg-indigo-100 transition-colors"
                                    >
