...
import { Wrench, AlertCircle, CheckCircle, Camera, X, ChevronLeft, Send, Loader2, Layers } from 'lucide-react'
        ...
        <div className="min-h-screen p-4 md:p-8" style={{ background: '#efefef' }}>
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <button onClick={onBack} className="p-2 transition-all border" style={{ background: '#fff', borderColor: '#e5e7eb', color: '#6b7280', borderRadius: '1rem' }}>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6" style={{ ...s.card }}>
...
export default function PortalChamadoEmpresa() {
    ...
    if (tela === 'sucesso') return (
        <><GlobalRoundedStyle /><SuccessScreen tipo={tipoSucesso} numeroChamado={numeroChamado} onNovoChamado={() => { setNumeroChamado(null); setTela('selecao') }} /></>
    )
