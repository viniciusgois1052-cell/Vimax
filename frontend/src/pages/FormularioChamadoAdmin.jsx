        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                    <FileText className="text-black" /> Formulários de Chamado
                </h1>
                {can('chamados','criar') && (
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm mb-4 border border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="relative">
                        ...
                        <input type="text" placeholder="Buscar por nome..."
                            className="w-full pl-9 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-gray-500 outline-none text-sm"
                            value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
                    </div>
                    <select className="p-2 border rounded-lg outline-none focus:ring-2 focus:ring-gray-500 text-sm"
                    ...
                    {filterEmpresa && filterTipo && (
                        <select className="p-2 border-2 border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-gray-500 text-sm bg-gray-50"
                ...
                {(searchTerm || filterEmpresa || filterTipo || filterVinculo) && (
                    <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-gray-100">
                        ...
                        {searchTerm && <span className="flex items-center gap-1 text-xs bg-gray-100 text-gray-700 px-2 py-1 rounded-full font-medium">"{searchTerm}" <button onClick={() => setSearchTerm('')}><X size={12} /></button></span>}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredFormularios.map(form => {
                    ...
                    return (
                        <Card key={form.id}
                            className={`transition-all border-2 group ${isSelected ? 'border-gray-400 shadow-md ring-2 ring-gray-200' : 'border-gray-200 hover:shadow-md'}`}>
                            <CardContent className="p-5">
                                <div className="flex justify-between items-start mb-3">
                                    ...
                                    <div className="flex gap-1 shrink-0 ml-1">
                                        ...
                                        <button onClick={() => handleOpenModal(form)}
                                            className="p-1.5 text-gray-600 hover:bg-gray-50 rounded-md transition-colors" title="Editar">
                                            <Edit2 size={15} />
                                        </button>
                                        )}
                                ...
                                {isSelected && (
                                    <div className="mt-3 pt-2 border-t border-gray-100">
                                        <span className="text-xs text-gray-500 font-bold">✓ Selecionado</span>
                                    </div>
                                )}
                            </CardContent>
                        </Card>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
                        ...
                        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-8 space-y-6">
                            <div>
                                ...
                                <input type="text" required className="w-full p-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-gray-500"
                            ...
                            <div>
                                ...
                                <select required className="w-full p-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-gray-500"
                      ...
                      >
                          ...
                          {(localizacoes || [])
                            ...
                            <div>
                                ...
                                <div className="flex gap-2 mb-3">
                                    <input type="text" placeholder="Digite um problema..."
                                        className="flex-1 p-2.5 border rounded-lg outline-none focus:ring-2 focus:ring-gray-500"
                                    ...
                                    <button type="button" onClick={handleAddOpcao}
                                        className="px-4 py-2.5 bg-black hover:bg-black text-white rounded-lg font-bold">Adicionar</button>
                                </div>
                            ...
                            <div className="pt-6 border-t flex justify-end gap-4">
                                ...
                                <button type="submit" className="px-12 py-2.5 bg-black hover:bg-gray-700 text-white rounded-xl font-bold shadow-lg">
