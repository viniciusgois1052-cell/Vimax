        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                    <FaUserFriends className="text-emerald-600" /> Gestão de Clientes
                </h1>
                <button
                    onClick={() => handleOpenModal()}
                    className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-all shadow-lg"
                >
                    <FaPlus /> Novo Cliente
                </button>
            </div>
                            ...
                            <tr key={c.id} className="hover:bg-emerald-50/30 transition-colors group">
                                ...
                                <td className="px-6 py-4">
                                    <div className="text-sm text-gray-600 space-y-1">
                                        ...
                                        {c.telefone && <div className="flex items-center gap-2"><FaPhone className="text-green-400 text-xs" />{c.telefone}</div>}
                                    </div>
                                </td>
                        ...
                        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2 bg-gray-50 p-6 rounded-xl border border-gray-100">
                                    <label className="block text-sm font-bold text-gray-700 mb-4 flex items-center gap-2"><FaBuilding className="text-emerald-600" /> Vincular Empresa</label>
                                    <select
                                        className="w-full p-2 border rounded-lg outline-none focus:ring-2 focus:ring-emerald-500"
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end gap-4">
                                ...
                                <button type="submit" className="px-10 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold shadow-lg transition-all">{isEditing ? 'Salvar Alterações' : 'Criar Cliente'}</button>
                            </div>
                        </form>
                    </div>
                </div>
