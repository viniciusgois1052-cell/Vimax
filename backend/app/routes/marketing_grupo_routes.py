...
def list_grupos():
    ...
    try:
        ...
        query = filter_owned(query, MarketingGrupo, user)
...
def create_grupo():
    ...
    try:
        ...
        db.session.commit()
        try:
            create_log(user=user, action='create_marketing_grupo', entity='marketing_grupo',
...
def update_grupo(id):
    ...
    try:
        ...
        db.session.commit()
        try:
            create_log(user=user, action='update_marketing_grupo', entity='marketing_grupo',
...
def delete_grupo(id):
    ...
    try:
        ...
        db.session.commit()
        try:
            create_log(user=user, action='delete_marketing_grupo', entity='marketing_grupo',
