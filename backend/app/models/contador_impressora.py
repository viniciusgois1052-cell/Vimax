...
class ContadorImpressora(db.Model):
    ...
    http_usuario = db.Column(db.String(100), nullable=True)
    http_senha   = db.Column(db.String(100), nullable=True)
    http_porta   = db.Column(db.Integer,     nullable=True)
    modelo       = db.Column(db.String(150))
    modelo_tipo  = db.Column(db.String(50))
    ...
    def to_dict(self):
        return {
            ...
            'http_usuario':  self.http_usuario,
            'http_senha':    self.http_senha,
            'http_porta':    self.http_porta,
            'modelo':        self.modelo,
            'modelo_tipo':   getattr(self, 'modelo_tipo', None),
